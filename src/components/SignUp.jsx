	...
	return (
		<Form>
			...
			<form class="forms" onSubmit={handleSubmit}>
				...
				<input type="text" className="inputs" name="lastname" value={state.lastname} onChange={handleChange} />
				<p class="address mail">*USERNAME</p>
				<input type="text" className="inputs" name="username" value={state.username} onChange={handleChange} />
				...
				<input type="password" className="inputs" name="password" onChange={handleChange} />
